...
<!--autoload_cluster=.-->
- [ ] `@user_001 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [Queimada](user_001/README.md)
- [ ] `@user_002 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [Fractais](user_002/README.md)
